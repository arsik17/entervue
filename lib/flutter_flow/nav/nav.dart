...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/multipleChoicePage',
          requireAuth: true,
          builder: (context, params) => MultipleChoicePageWidget(
            areaRef: params.getParam(
              'areaRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['areas'],
            ),
          ),
        ),
        FFRoute(
          name: 'fillBase',
          path: '/fillBase',
          builder: (context, params) => FillBaseWidget(),
        )
